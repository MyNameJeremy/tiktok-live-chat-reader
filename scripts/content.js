    ...
    function addReconnectButton() {
      let buttonHtmlAndCss = /*html*/ `
        <style>
          ...
          #reconnect-button:hover::before, button:hover::after {
          transform: scale(0)
          }
      ...
      `;
      document.getElementsByClassName('tiktok-kidgju-DivHeaderWrapperMain')[0].innerHTML += buttonHtmlAndCss;
